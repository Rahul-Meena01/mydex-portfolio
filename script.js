...
const portfolioData = {
  ...
  badges: [
    ...
    },
    {
      ...
      description:
        "Awarded first place in regional coding hackathon for developing an innovative solution to a real-world problem within a 48-hour timeframe.",
      icon: "🏆",
    },
  ],
  moves: {
